...
template<class Ar>
inline void save_construct_data( Ar &ar, const pagmo::problem::SolarSailFormationFlying * t,
    const unsigned int file_version ){
...
template<class Ar>
inline void load_construct_data( Ar &ar, pagmo::problem::SolarSailFormationFlying * t,
    const unsigned int file_version ){
...
BOOST_CLASS_EXPORT_KEY( pagmo::problem::SolarSailFormationFlying );
