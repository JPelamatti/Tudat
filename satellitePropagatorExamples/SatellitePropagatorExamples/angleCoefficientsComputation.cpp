...
std::vector<std::vector<double>> polynomialCoefficients (const decision_vector &xv, double deltaT)
{
    ...
    c4 = (a4*(e4*e41*e4-(e4+deltaT)*(e4+deltaT)*(e4+deltaT))+b4*(e4*e4-(e4+deltaT)*(e4+deltaT)))/deltaT;
